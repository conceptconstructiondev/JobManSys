...
//         accepted_by: "David",
//         accepted_at: "2024-01-14T08:00:00Z",
//         onsite_time: "2024-01-15T08:30:00Z",
//         completed_time: null,
//         invoiced: false,
//         work_started_image: "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=400&h=300&fit=crop",
//         work_started_notes: "Arrived on site. Multiple leak points identified on east side of roof. Temporary tarps installed to prevent further water damage. Beginning permanent membrane repair work.",
//       },
//       {
...
//         status: "onsite" as const,
//         accepted_by: "Alex",
//         accepted_at: "2024-01-15T07:00:00Z",
//         onsite_time: "2024-01-16T07:00:00Z",
//         completed_time: null,
//         invoiced: false,
//         work_started_image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop",
//         work_started_notes: "Cable routing planned and marked. Began pulling cables through ceiling. First 10 drops completed successfully. Network testing in progress.",
//       },
//       {
...
//         completed_time: "2024-01-10T16:30:00Z",
//         invoiced: false,
//         work_started_image: "https://images.unsplash.com/photo-1557804506-669a67965ba0?w=400&h=300&fit=crop",
//         work_started_notes: "Old analog system removed. New IP camera locations marked and verified with store manager. Power and network runs completed.",
//         work_completed_image: "https://images.unsplash.com/photo-1609220136736-443140cffec6?w=400&h=300&fit=crop",
//         work_completed_notes: "All 12 IP cameras installed and configured. NVR system operational with 30-day recording capacity. Mobile app set up for store manager. All cameras tested and functioning properly. System documentation provided.",
//       },
//       {
...
//         status: "completed" as const,
//         accepted_by: "Lisa",
//         accepted_at: "2024-01-11T06:00:00Z",
//         onsite_time: "2024-01-12T06:00:00Z",
//         completed_time: "2024-01-12T11:45:00Z",
//         invoiced: true,
//         work_started_image: "https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=400&h=300&fit=crop",
//         work_started_notes: "Pre-maintenance inspection complete. All 4 units accessible. Old filters heavily soiled and due for replacement. Beginning filter change and coil cleaning.",
//         work_completed_image: "https://images.unsplash.com/photo-1609220136736-443140cffec6?w=400&h=300&fit=crop",
//         work_completed_notes: "All units serviced successfully. New high-efficiency filters installed. Coils cleaned and inspected. System performance optimal. No issues found. Next maintenance due in 3 months.",
//       },
//       {
...
//         status: "completed" as const,
//         accepted_by: "Carlos",
//         accepted_at: "2024-01-07T14:00:00Z",
//         onsite_time: "2024-01-08T14:00:00Z",
//         completed_time: "2024-01-08T18:20:00Z",
//         invoiced: true,
//         work_started_image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=300&fit=crop",
//         work_started_notes: "Surveyed all parking lot lighting. Found 6 failed LED fixtures and 2 with damaged photocells. Beginning replacement work with boom lift.",
//         work_completed_image: "https://images.unsplash.com/photo-1609220136736-443140cffec6?w=400&h=300&fit=crop",
//         work_completed_notes: "All 6 LED fixtures replaced with new units. 2 photocells replaced. Full parking lot now properly illuminated. All lights tested and functioning correctly. 5-year warranty on new fixtures.",
//       },
//       {
...
//   const [results, setResults] = useState<Array<{title: string, id?: string, error?: string}>>([])
...
//     const newResults: Array<{title: string, id?: string, error?: string}> = []
...
//         newResults.push({ title: job.title, id: jobId })
//         console.log(`✅ Created: ${jobId}`)
//       } catch (jobError) {
//         console.error(`❌ Error creating ${job.title}:`, jobError)
//         newResults.push({ 
//           title: job.title, 
...
//       <h1 className="text-2xl font-bold mb-4">Populate Dummy Data</h1>
...
//         className="mb-6"
//       >
//         {loading ? 'Creating jobs...' : completed ? 'Data populated!' : `Create ${dummyJobs.length} Jobs`}
//       </Button>
...
//               {result.id && <span className="text-green-600 ml-2">✅ Created: {result.id}</span>}
//               {result.error && <span className="text-red-600 ml-2">❌ Error: {result.error}</span>}
//             </div>
//           ))}
//         </div>
//       )}
